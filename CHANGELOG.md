...
- `AccessBanner.tsx` - update old hook references
- `ArticleMeta.tsx` - update old hook references
- `CategoryCard.tsx` - update old hook references
- `CategoryList.tsx` - update old hook references
